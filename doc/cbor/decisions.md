...
| ciborium 0.2.2, with independent Python reference codec. | Debian stable packages the reader dependency for the required architectures. Independent code reduces shared encoder/decoder mistakes; it does not replace frozen fixtures. |
